package com.degrize.myapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.degrize.myapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.degrize.myapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
