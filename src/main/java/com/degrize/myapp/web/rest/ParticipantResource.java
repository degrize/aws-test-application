...
/**
 * REST controller for managing {@link com.degrize.myapp.domain.Participant}.
 */
@RestController
@RequestMapping("/api")
public class ParticipantResource {
    ...
    public ResponseEntity<List<ParticipantDTO>> getAllParticipants(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
